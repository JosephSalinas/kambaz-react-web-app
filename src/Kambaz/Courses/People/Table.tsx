            ...
            <table className="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-09-19</td>
                        <td className="wd-total-activity">19:33:20</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-08-29</td>
                        <td className="wd-total-activity">14:10:15</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">16:27:10</td>
                    </tr>
                </tbody>
            </table>
        </div>
