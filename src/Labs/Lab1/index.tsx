    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                <h4>Paragraph Tag</h4>
                <p id="wd-p-1"> ... </p>
                <p id="wd-p-1"> This is the first paragraph. The paragraph tag is used to format vertical gaps between
                    long pieces of text like this one.
                </p>
                <p id="wd-p-2"> This is the second paragraph. Even though there is a deliberate white gap between the
                ...
                <p id="wd-p-3"> This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers
                    to render the gaps.
                </p>
            </div>
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Add the thing.</li>
                    <li>Add the other thing.</li>
                    <li>Mix the things until a thing has thinged.</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <label htmlFor="wd-radio-fantasy">Fantasy
                    </label>
            ...
            <a href="https://github.com/JosephSalinas/kambaz-react-web-app" id="wd-github">Github</a>
        </div>
    );
}